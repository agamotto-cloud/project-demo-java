...
import org.agamotto.cloud.demo.exception.DemoException;
...
public class GlobalExceptionHandle extends DefaultErrorWebExceptionHandler {
    ...
    protected Map<String, Object> getErrorAttributes(ServerRequest request, boolean includeStackTrace) {
        ...
        if (error instanceof DemoException) {
            return response(((DemoException) error).getCode(), this.buildMessage(request, error.getMessage()));
        }
